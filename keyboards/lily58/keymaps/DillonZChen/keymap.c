...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_HOME, KC_END,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                   KC_NO,   KC_LGUI, LOWER,   KC_ENT,  KC_SPC,  RAISE,   KC_RALT, KC_NO
    ),
    ...
    [_ADJUST] = LAYOUT(
        ...
        KC_CAPS, _______, WS_LEFT, WS_DOWN, WS_RGHT, _______,                    _______, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______,
...
void matrix_scan_user(void) {
    if (lower0_tapped && timer_elapsed(lower_tap_timer) > _LOWER_TAP_TIME) {
        lower0_tapped = false;
    }
}
